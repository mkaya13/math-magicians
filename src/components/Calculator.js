...
const CalculatorUI = () => {
  ...
  return (
    <div>
      <div className="flex-container" data-testid="calculator-items">
        ...
        <button type="button" data-testid="4" onClick={buttonHandler} className="box-type-2 box-10">4</button>
        <button type="button" data-testid="5" onClick={buttonHandler} className="box-type-2 box-11">5</button>
        <button type="button" data-testid="6" onClick={buttonHandler} className="box-type-2 box-12">6</button>
        ...
        <button type="button" data-testid="+" onClick={buttonHandler} className="box-type-2 orange-box box-17">+</button>
        ...
        <button type="button" data-testid="=" onClick={buttonHandler} className="box-type-2 orange-box box-20">=</button>
      </div>
    </div>
  );
};
